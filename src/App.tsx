  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-indigo-600 selection:text-white">
      ...
      <div className="flex-1 relative">
        ...
        >
          {/* Main Title Banner */}
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 mb-4 sm:mb-6 bg-slate-900/80 border border-slate-800 p-3.5 sm:p-6 rounded-xl sm:rounded-2xl shadow-xl backdrop-blur-md">
            <div>
              <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] sm:text-xs font-semibold uppercase tracking-wider mb-1.5 font-mono">
                <TrendingUp className="w-3.5 h-3.5" /> SNGxJOURNAL Enterprise
              </div>
              <h1 className="text-xs sm:text-base md:text-lg font-bold text-white tracking-normal leading-snug">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className="flex-1 sm:flex-none px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-lg sm:rounded-xl bg-emerald-950/80 hover:bg-emerald-900 text-emerald-300 border border-emerald-500/40 text-[11px] sm:text-xs font-bold transition-all flex items-center justify-center gap-1.5 shadow-md shadow-emerald-500/10 active:scale-95"
              >
              ...
              <button
                ...
                className="flex-1 sm:flex-none px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-lg sm:rounded-xl bg-slate-800 hover:bg-rose-950 text-rose-400 border border-rose-900/50 text-[11px] sm:text-xs font-bold transition-all flex items-center justify-center gap-1.5 shadow-md"
              >
          ...
          {/* Controls Bar */}
          <div className="bg-slate-900 border border-slate-800 rounded-xl sm:rounded-2xl p-3.5 sm:p-5 mb-4 sm:mb-6 shadow-lg grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4">
            <div>
          ...
          {/* Tab Navigation */}
          <div className="flex border-b border-slate-800 mb-4 sm:mb-6 gap-1.5 sm:gap-2 overflow-x-auto pb-0.5 no-scrollbar">
            <button
              onClick={() => setActiveTab("grid")}
              className={`px-3 sm:px-5 py-2 sm:py-3 text-[11px] sm:text-xs md:text-sm font-bold rounded-t-lg sm:rounded-t-xl transition-all flex items-center gap-1.5 border-t border-x shrink-0 whitespace-nowrap ${
                activeTab === "grid"
            ...
            >
              <TableIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> Data Sheet Grid
            </button>
            ...
            >
              <Target className="w-3.5 h-3.5 sm:w-4 sm:h-4" /> Trading Goals
            </button>
          </div>
